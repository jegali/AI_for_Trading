# Analyzing Stock Sentiments from Twits

This folder contains the workspace for the course project. The main file is 

[project_6_starter.ipynb](https://github.com/jegali/AI_for_Trading/tree/main/Trading_with_Momentum/project_1_starter.ipynb)
